...
![图3：odc_pad——为对齐各 rank 微批数而补"空桶"，trace 呈单个密集 burst](odc_blog/fig5_odc_pad.png)
...
![图4：odc_nopad——各 rank 按真实变长负载跑、微批数可不同、免补空桶，trace 呈两段密集 burst](odc_blog/fig6_odc_nopad.png)
