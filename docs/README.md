...
- **[Tuning Agent](./tuning_agent.md)** - LLM-driven search for an optimal parallelization config (drives the projection tool as an oracle)
...
- **Auto-tune my parallelization config** → [Tuning Agent](./tuning_agent.md)
