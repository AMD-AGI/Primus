...
- [SpecForge (offline DFlash)](../examples/specforge/README.md): `primus-cli` entrypoint for SpecForge capture and train
...
| Train a SpecForge DFlash draft on ROCm | [SpecForge on Primus](../examples/specforge/README.md) |
