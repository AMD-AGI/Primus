...
# Default Megatron ``jit_fuser`` is ``torch.compile`` on torch>=2.2; TorchInductor's async
# compile workers deadlock under torchrun + Energon/DataLoader workers and elastic sends SIGTERM.
