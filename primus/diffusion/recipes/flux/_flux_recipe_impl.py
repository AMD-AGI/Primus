...
"""FLUX 12B recipe implementation (heavy imports). Loaded only when the recipe runs."""
...
from primus.diffusion.conversion.flux.flux_bridge import FluxBridge
from primus.diffusion.conversion.flux.flux_hf_pretrained import PreTrainedFlux
from primus.diffusion.data.flux.flux_energon_datamodule import FluxDatasetConfig
...
def flux_12b_pretrain_config() -> ConfigContainer:
    ...
    precision_config = get_mixed_precision_config("bf16_with_fp8_delayed_scaling_mixed")
