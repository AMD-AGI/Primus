...
"""
Legacy PrimusAttentionOp for Aug-version MaxText (date-versioned, e.g. ``2025.07.24``).

Simpler implementation without ``nnx_wrappers.ToNNX`` / ``lazy_init``, and uses
``mask=`` keyword instead of ``sequence_descriptor=``.
"""
