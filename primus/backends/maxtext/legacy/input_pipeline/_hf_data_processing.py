...
"""
Legacy HF data processing for Aug-version MaxText (date-versioned, e.g. ``2025.07.24``).

Uses ``CustomPackAndBatchOperation``, ``max_segments``, ``PadToMaxLength``,
and ``generate_padding_example`` keywords that were renamed / replaced in the
Dec version.
"""
