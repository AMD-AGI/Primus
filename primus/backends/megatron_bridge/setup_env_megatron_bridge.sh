...
MEGATRON_BRIDGE_TOML_SRC="/workspace/Primus/primus/backends/megatron_bridge/patches/pyproject.toml"
MEGATRON_BRIDGE_TOML_DST="/workspace/Primus/third_party/megatron-bridge/pyproject.toml"

PRIMUS_THIRD_PARTY="/workspace/Primus/third_party"
...
########################################
# 1) Transformers (must be in /workspace)
########################################
mkdir -p "$WORKSPACE"
cd "$WORKSPACE"
