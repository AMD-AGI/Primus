...
def patch_moe_swiglu_nocat(ctx: PatchContext):
    ...
    log_rank_0("[Patch:megatron.moe.swiglu_nocat] Installing Triton SwiGLU+probs " "(no cat/split in bwd)")
    ...
    if ok:
        ...
        log_rank_0("[Patch:megatron.moe.swiglu_nocat]   install() returned False " "(precondition not met)")
