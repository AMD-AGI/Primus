...
def patch_filesystem_writer_async(ctx: PatchContext):
    ...
    warning_rank_0("MegatronPatches: Patching FileSystemWriterAsync...")
    try:
        import megatron.core.dist_checkpointing.strategies.filesystem_async as filesystem_async_module

        from primus.backends.megatron.patches.core.dist_checkpointing.strategies.filesystem_async import (
