...
def patch_custom_recompute_layer_ids(ctx: PatchContext):
    ...
    if module_config is None or getattr(module_config, "recompute_layer_ids", None) is None:
        # Nothing to do if user did not configure custom recompute_layer_ids
        return
    ...
    try:
        ...
        config_mod.TransformerConfig.recompute_layer_ids = module_config.recompute_layer_ids
