...
class PrimusTurboSpecProvider(BackendSpecProvider):
    ...
    def core_attention(self) -> type:
        ...
        return (
            ...
            if getattr(self.cfg, "use_turbo_attention", False)
    ...
    def grouped_mlp_modules(
        ...
        use_turbo_grouped_gemm = getattr(self.cfg, "use_turbo_grouped_gemm", False) or getattr(
            self.cfg, "use_turbo_grouped_mlp", False
        )
        assert not (
