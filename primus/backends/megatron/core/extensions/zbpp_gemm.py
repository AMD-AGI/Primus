...
class LinearWithWeightGradientStore(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        insert_wgrad_func_into_cache(weight, functools.partial(pre_process, grad_output, input), functools.partial(process_wgrad, weight, wgrad_gemm_accum_func=wgrad_gemm_accum_func))
