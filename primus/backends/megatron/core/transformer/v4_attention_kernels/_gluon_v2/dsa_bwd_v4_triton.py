...
"""DeepSeek-V4 sparse-MLA backward for the "gluon_v2" backend (currently plain-Triton).

This is the gluon_v2 backend's backward entry point (:func:`sparse_mla_bwd_v4_gluon_v2`).
It is presently a plain-Triton implementation being migrated to Gluon; API mirrors
