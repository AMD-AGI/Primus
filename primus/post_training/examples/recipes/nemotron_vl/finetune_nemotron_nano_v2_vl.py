...
from post_training.training.llava_step import forward_step
...
def main() -> None:
    ...
    from post_training.recipes.nemotron_vl.nemotron_nano_v2_vl import nemotron_nano_v2_vl_12b_finetune_config
