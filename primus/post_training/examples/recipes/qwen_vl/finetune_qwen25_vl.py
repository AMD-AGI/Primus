...
from post_training.recipes.qwen_vl import qwen25_vl as qwen_vl_recipes
...
from post_training.training.vlm_step import forward_step
...
def parse_cli_args() -> Tuple[argparse.Namespace, list[str]]:
    ...
    parser.add_argument(
        ...
        help=(
            "Name of the recipe function in post_training.recipes.qwen_vl.qwen25_vl to use, "
