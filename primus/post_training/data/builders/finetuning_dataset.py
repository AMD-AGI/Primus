...
from post_training.data.datasets.sft import create_sft_dataset
from post_training.training.tokenizers.tokenizer import _HuggingFaceTokenizer
...
class FinetuningDatasetBuilder:
    ...
    def prepare_packed_data(self) -> None:
        ...
        if self.packed_sequence_size > 0:
            from post_training.data.datasets.packed_sequence import prepare_packed_sequence_data
