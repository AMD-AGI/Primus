...
from post_training.data.datasets.utils import IGNORE_INDEX
from post_training.data.vlm_datasets.token_utils import extract_skipped_token_ids
from post_training.training.utils.visual_inputs import Qwen2_5_VLVisualInputs
...
def nemotron_nano_v2_vl_collate_fn(examples: list, processor, start_of_response_token=None) -> dict[str, torch.Tensor]:
    ...
    from post_training.models.nemotron_vl.nemotron_vl_utils import adjust_image_tokens
    ...
    if is_video:
        from post_training.models.nemotron_vl.nemotron_vl_utils import (
