...
from post_training.models.transformer_config import TransformerConfig
from post_training.utils import fusions
...
def transformer_engine_full_layer_spec(config: "GPTModelProvider") -> ModuleSpec:
    ...
    """
    from post_training.models.gpt_full_te_layer_autocast_spec import get_gpt_full_te_layer_autocast_spec
