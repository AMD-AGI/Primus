...
from post_training.models.conversion.mapping_registry import MegatronMappingRegistry
from post_training.models.conversion.param_mapping import MegatronParamMapping
from post_training.models.conversion.utils import (
    extract_sort_key,
    get_module_and_param_from_name,
    persistent_buffers,
)
from post_training.models.decorators.dispatch import dispatch
from post_training.models.model_provider import ModelProviderMixin
...
class MegatronModelBridge(Generic[HFPreTrained, ModelProviderTarget, MegatronModel]):
    ...
    def _merge_lora_adapter_weights(
        ...
        from post_training.models.conversion.param_mapping import ColumnParallelMapping, RowParallelMapping
        from post_training.peft.lora import LoRAMerge
        from post_training.peft.utils import HAVE_TE, TECL, TERL
