...
from post_training.models.conversion import model_bridge
from post_training.models.conversion.model_bridge import (
    HFWeightTuple,
    MegatronModelBridge,
    WeightConversionTask,
)
from post_training.models.conversion.utils import get_causal_lm_class_via_auto_map
from post_training.models.gpt_provider import GPTModelProvider
from post_training.models.hf_pretrained.causal_lm import PreTrainedCausalLM
from post_training.models.hf_pretrained.safe_config_loader import safe_load_config_with_retry
from post_training.models.hf_pretrained.state import SafeTensorsStateSource
from post_training.models.model_provider import GetModelKwargs, ModelParallelKwargs, ModelProviderMixin
...
class AutoBridge(Generic[MegatronModelT]):
    ...
    def save_megatron_model(
        ...
        """
        try:
            from post_training.training.model_load_save import save_megatron_model
        except ImportError:
            raise ImportError("post_training.training is not available.")
    ...
    def load_megatron_model(
        ...
        """
        try:
            from post_training.training.model_load_save import load_megatron_model
        except ImportError:
            raise ImportError("post_training.training is not available.")
    ...
    def export_ckpt(
        ...
        """
        try:
            from post_training.training.model_load_save import temporary_distributed_context
        except ImportError:
            raise ImportError("post_training.training is not available.")
    ...
    def get_hf_model_id_from_checkpoint(path: str | Path) -> str | None:
        ...
        Returns:
            ...
            otherwise `None`.
        """
        from post_training.training.utils import checkpoint_utils as _checkpoint_utils
            ...
            if hasattr(model_bridge.get_model_bridge, "_exact_types"):
                ...
                if not has_implementation:
                    ...
                    raise ValueError(
                        ...
                        f"  from post_training.models.conversion.model_bridge import MegatronModelBridge\n"
