...
from post_training.data.utils import get_dataset_provider
...
from post_training.training.setup import setup
from post_training.training.state import GlobalState
from post_training.training.train import _finish_train, train
from post_training.training.utils.log_utils import barrier_and_log
from post_training.utils.common_utils import print_rank_0
from post_training.utils.decorators import experimental_fn
...
def pretrain(
    ...
    if config.inprocess_restart and config.inprocess_restart.enabled:
        ...
        from post_training.training.inprocess_restart import maybe_wrap_for_inprocess_restart
