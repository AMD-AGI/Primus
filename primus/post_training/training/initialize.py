...
from post_training.training.config import ConfigContainer, DistributedInitConfig, RerunStateMachineConfig, RNGConfig
...
def torch_dist_init(
    ...
    def finish_mpu_init():
        ...
        _set_random_seed(
            ...
            use_cudagraphable_rng=(model_config.cuda_graph_scope != "none"),
        )
