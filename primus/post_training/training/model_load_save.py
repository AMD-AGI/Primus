...
from post_training.models.model_provider import ModelParallelKwargs, ModelProviderMixin
from post_training.training.checkpointing import save_checkpoint
from post_training.training.config import CheckpointConfig, ConfigContainer, LoggerConfig
from post_training.training.state import GlobalState
from post_training.training.tokenizers.tokenizer import MegatronTokenizer, build_tokenizer
from post_training.training.utils.checkpoint_utils import file_exists
from post_training.utils.vocab_utils import calculate_padded_vocab_size
...
def load_tokenizer(checkpoint_path: str, **kwargs) -> MegatronTokenizer:
    ...
    """
    from post_training.training.checkpointing import (
        get_checkpoint_run_config_filename,
        read_run_config,
    )
    from post_training.training.mlm_compat.arguments import _load_args_from_checkpoint, _tokenizer_config_from_args
    from post_training.utils.instantiate_utils import instantiate
...
def load_model_config(
    ...
    from post_training.training.mlm_compat.arguments import _load_args_from_checkpoint, _transformer_config_from_args
    from post_training.utils.instantiate_utils import instantiate
...
def build_and_load_model(
    ...
    from post_training.training.mlm_compat.arguments import _tokenizer_config_from_args
    from post_training.training.mlm_compat.model import _get_model, _gpt_provider, _mamba_provider
    from post_training.training.post_training.checkpointing import has_modelopt_state
    ...
    def _load_checkpoint():
        ...
        if getattr(model_cfg, "restore_modelopt_state", False):
            from post_training.training.post_training.checkpointing import (
                load_modelopt_state,
            )
...
def save_megatron_model(
    ...
    if hf_tokenizer_path is not None:
        from post_training.training.tokenizers.config import TokenizerConfig
