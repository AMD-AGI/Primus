...
from post_training.data.loaders import setup_data_iterators
from post_training.models import GPTModelProvider, T5ModelProvider
...
from post_training.training.config import ConfigContainer, runtime_config_update
from post_training.training.initialize import initialize_megatron, set_jit_fusion_options
from post_training.training.optim import setup_optimizer
from post_training.training.state import GlobalState
from post_training.training.tokenizers.tokenizer import build_tokenizer
from post_training.training.utils.log_utils import append_to_progress_log, barrier_and_log, setup_logging
from post_training.training.utils.weight_decay_utils import get_no_weight_decay_cond
from post_training.utils.common_utils import print_rank_0, get_rank_safe
...
def setup(
    ...
    if getattr(cfg.model, "restore_modelopt_state", False):
        from post_training.training.post_training.checkpointing import load_modelopt_state
