...
from post_training.training.utils.train_utils import prepare_forward_step_func
from post_training.utils.common_utils import is_last_rank, print_rank_0, print_rank_last
...
def evaluate(
    ...
    with torch.no_grad():
        ...
        if state.cfg.model.cuda_graph_scope == "local" and "full_iteration" in state.cfg.model.cuda_graph_scope:
