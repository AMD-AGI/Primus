...
from post_training.training.losses import masked_next_token_loss
from post_training.training.post_training.distillation import loss_func_kd
from post_training.training.state import GlobalState
from post_training.training.utils.packed_seq_utils import get_packed_seq_params
...
def _create_loss_function_modelopt(
    ...
    `post_training.training.gpt_step.masked_next_token_loss`.
