...
from post_training.training import fault_tolerance
from post_training.training.checkpointing import maybe_finalize_async_save, save_checkpoint
from post_training.training.config import ConfigContainer
from post_training.training.eval import evaluate_and_print_results
from post_training.training.forward_step_func_types import ForwardStepCallable
from post_training.training.initialize import destroy_global_state
from post_training.training.nvrx_straggler import (
    check_nvrx_straggler_detection,
    safe_shutdown_nvrx_straggler_manager,
)
from post_training.training.profiling import (
...
from post_training.training.tensor_inspect import (
    tensor_inspect_end_if_enabled,
    tensor_inspect_step_if_enabled,
)
from post_training.training.utils import flop_utils
from post_training.training.utils.log_utils import append_to_progress_log, barrier_and_log
from post_training.training.utils.train_utils import (
    calc_params_l2_norm,
...
from post_training.utils.common_utils import get_world_size_safe, print_rank_0
...
def train(
    ...
    if model_config.cuda_graph_scope == "transformer_engine":
    ...
    if config.model.cuda_graph_scope == "local" and "full_iteration" in config.model.cuda_graph_scope:
    ...
    while global_state.train_state.step < train_config.train_iters:
        ...
        if (
            model_config.cuda_graph_scope == "transformer_engine"
...
def train_step(
    ...
    while rerun_state_machine.should_run_forward_backward(data_iterator):
        ...
        if cfg.dataset.dataloader_type == "batch":
            ...
            from post_training.data.finetuning import prepare_finetuning_batch
            from post_training.data.iterator_utils import make_data_iterator_list
