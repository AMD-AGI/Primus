...
from post_training.utils.common_utils import get_rank_safe, get_world_size_safe, print_rank_0
...
def setup_logging(
    ...
    Args:
        ...
        set_level_for_all_loggers: If True, sets the logging level for all existing
                                   ...
                                   for the root logger and loggers starting with 'post_training'.
    """
    ...
    for _logger_name in logging.root.manager.loggerDict:
        if _logger_name.startswith("post_training") or set_level_for_all_loggers:
