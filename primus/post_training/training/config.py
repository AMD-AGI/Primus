...
from post_training.data.datasets.packed_sequence import PackedSequenceSpecs
from post_training.models import GPTModelProvider, T5ModelProvider
from post_training.models.mamba.mamba_provider import MambaModelProvider
from post_training.peft.base import PEFT
from post_training.training.comm_overlap import CommOverlapConfig
from post_training.training.flex_dispatcher_backend import validate_flex_dispatcher_backend
from post_training.training.mixed_precision import MixedPrecisionConfig, get_mixed_precision_config
from post_training.training.tokenizers.config import TokenizerConfig
from post_training.training.tokenizers.tokenizer import MegatronTokenizer
from post_training.training.utils.config_utils import _ConfigContainerBase as Container
from post_training.utils.common_utils import (
    get_world_size_safe,
    print_rank_0,
    warn_rank_0,
)
...
class NVRxStragglerDetectionConfig:
    ...
    logger_name: str = "post_training.NVRxStragglerDetection"
