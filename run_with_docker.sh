...
DOCKER_IMAGE=${DOCKER_IMAGE:-zirui3/primus-flux-mxfp8@sha256:0b2ca53f3d74371e254033187792cb8057ad832191422dba5ac65079719c0a69}
export PRIMUS_DEPENDENCY_IMAGE=$DOCKER_IMAGE
...
env_names=(
    ...
    LOCAL_BATCH_SIZE DATALOADER_NUM_WORKERS MAX_STEPS LR WARMUP_STEPS SEED LOG_FREQ TARGET_ACCURACY
    VAL_CHECK_INTERVAL MLPERF_ENABLE MLPERF_CLEAR_CACHES ATTENTION_BACKEND PRIMUS_FLUX_CACHE_ROOT
    PRIMUS_DEPENDENCY_IMAGE
    GRADIENT_CHECKPOINTING COMPILE_TRANSFORMER_BLOCKS FSDP2_RESHARD_AFTER_FORWARD
    FLUX_LOW_PRECISION_PROVIDER FLUX_LOW_PRECISION_RECIPE PRIMUS_TURBO_MXFP8_USE_FLUX_CONFIGS
)
docker_env_args=()
