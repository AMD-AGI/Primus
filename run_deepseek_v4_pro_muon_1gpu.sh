...
#   PRIMUS_TOTAL_LAYERS=6 ./run_deepseek_v4_pro_muon_1gpu.sh            # deeper slice
#                                                                       #   (watch HBM: +~50GB/layer at 48 experts)
...
# prevents it (kernels stay async; measured cost ~4-5% iter time on the eager
