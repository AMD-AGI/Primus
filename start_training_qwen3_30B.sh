...
export SLURM_NODELIST="chi[2870]"
...
export PRIMUS_RECOMPUTE_LAYERS=10
export PRIMUS_PP=1
export PRIMUS_EP=8
export PRIMUS_VPP=1
...
export PRIMUS_EXP_NAME=qwen3_30B-pretrain-mbs_$MBS-gbs_$GBS-PP_$PRIMUS_PP-EP_$PRIMUS_EP-VPP_$PRIMUS_VPP-turbodeepep_$TURBO_DEEPEEP-legacygg_$LEGACY_GG-profile_$PROFILE
