...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=4,
        help=(
            "Proxy-mode buffer rotation: allocate N independent copies of Q/K/V and "
            "rotate through them per iteration, so each call reads fresh HBM addresses "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "iterations to evict cached Q/K/V tiles. Set to 0 to disable."
        ),
    )
...
def main() -> None:
    ...
    shape = {
        ...
        "P": pool[0]["P"],
        "Sk": pool[0]["Sk"],
        "hca_local_seqlen": pool[0]["hca_local_seqlen"],
