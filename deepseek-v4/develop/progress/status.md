...
| [x] | Retire legacy `DeepseekV4MTPBlock` (delete) | `e591b893` | 2026-05-01 | `primus/backends/megatron/core/models/deepseek_v4/deepseek_v4_mtp.py` deleted; spec-based path via `get_v4_mtp_block_spec` is the only MTP route. Package `__init__` no longer exports the symbol. |
