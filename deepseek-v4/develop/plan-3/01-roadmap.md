...
|---|---|---|---|
| **M0: Plan-3 locked** | Plan docs + status.md tracking opened (Phase 20–24) | (kick-off commit) | ✅ done |
...
| **M2: Turbo wiring** | `core_attention` reaches dense V4 layers; `PrimusTurboDeepEPTokenDispatcher` reaches every routed V4 MoE layer | P22 + P23 | open |
| **M3: Turbo smoke green** | `run_deepseek_v4.sh` with full Turbo flags passes the four P19 configs | P24 | open |
