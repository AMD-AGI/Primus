...
| **M1: Reporting + hygiene** | V4 TFLOPs match the V4 closed form within 1%; no projection / sink / compressor / indexer warning-fallback paths in tree | P20 + P21 | 🔄 P20 done, P21 open |
