...
|---|---|---|---|
| **M0: Plan-3 locked** | Plan docs + status.md tracking opened (Phase 20–23) | (kick-off commit) | ✅ done |
| **M1: Reporting + hygiene** | V4 TFLOPs match the V4 closed form within 1%; no projection / sink / compressor / indexer warning-fallback paths in tree | P20 + P21 | ✅ both done (2026-05-07) |
| **M2: Turbo wiring** | `core_attention` reaches dense V4 layers; `PrimusTurboDeepEPTokenDispatcher` reaches every routed V4 MoE layer | P22 + P23 | ✅ done (2026-05-07) — wiring + unit tests green; aiter Triton kernel upgrades for full Flash dims tracked into a future perf plan |
