...
#   (`MBS=16 bash examples/megatron/models/kimi-k3/run_kimi_k3_curve_pretrain_mi355x.sh`)
...
#   Mirrors examples/megatron/guides/moe_package/run_glm5_4layers_proxy.sh: for ONE node we drive
...
#   bash examples/megatron/models/kimi-k3/run_kimi_k3_curve_pretrain_mi355x.sh
###############################################################################
...
# Mirrors examples/megatron/guides/moe_package/run_glm5_4layers_proxy.sh -- drive primus-cli
