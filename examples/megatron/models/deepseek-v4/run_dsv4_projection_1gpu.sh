...
# Repo root: this script lives under examples/megatron/models/deepseek-v4/, so resolve two levels
...
export PYTHONPATH_IN="$SCRIPT_DIR/examples/megatron/models/deepseek-v4/rccl_avg_workaround:$SCRIPT_DIR/third_party/Emerging-Optimizers"
