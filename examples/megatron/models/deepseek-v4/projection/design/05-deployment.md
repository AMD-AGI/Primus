...
`build_site_bundle.py` copies `examples/megatron/models/deepseek-v4/projection/site/` into the bundle at
...
```bash
python3 -m http.server -d examples/megatron/models/deepseek-v4/projection/site 8011
