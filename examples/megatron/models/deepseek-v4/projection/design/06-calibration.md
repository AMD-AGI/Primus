...
LAYERS=16 GBS=64 bash examples/megatron/models/deepseek-v4/projection/script/_calibrate_flash.sh   # (helper; not committed)
# analytic flops self-test
python3 examples/megatron/models/deepseek-v4/projection/tools/v4_flops.py
```
