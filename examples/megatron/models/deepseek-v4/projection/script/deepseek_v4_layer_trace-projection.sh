...
# *projection* pipeline (examples/megatron/models/deepseek-v4/projection).
#
...
#   MODEL=flash CR=4 ./examples/megatron/models/deepseek-v4/projection/script/deepseek_v4_layer_trace-projection.sh
#
