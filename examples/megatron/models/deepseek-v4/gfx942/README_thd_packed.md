...
bash examples/megatron/models/deepseek-v4/gfx942/run_128k_thd_packed.sh

# three nodes: run on each, NODE_RANK 0 / 1 / 2
MASTER_ADDR=<node0-ip> NODE_RANK=<r> bash examples/megatron/models/deepseek-v4/gfx942/run_full_4k_thd_multinode.sh
MASTER_ADDR=<node0-ip> NODE_RANK=<r> bash examples/megatron/models/deepseek-v4/gfx942/run_full_128k_thd_multinode.sh
```
