...
#
#   MASTER_ADDR=<node0-ip> NODE_RANK=0 bash examples/megatron/models/deepseek-v4/gfx942/run_full_4k_thd_multinode.sh
#   MASTER_ADDR=<node0-ip> NODE_RANK=1 bash examples/megatron/models/deepseek-v4/gfx942/run_full_4k_thd_multinode.sh
#   MASTER_ADDR=<node0-ip> NODE_RANK=2 bash examples/megatron/models/deepseek-v4/gfx942/run_full_4k_thd_multinode.sh
#
