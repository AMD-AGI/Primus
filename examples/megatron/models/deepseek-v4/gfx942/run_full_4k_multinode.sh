...
#   MASTER_ADDR=<node0-ip> NODE_RANK=0 bash examples/megatron/models/deepseek-v4/gfx942/run_full_4k_multinode.sh
#   # node 1:
#   MASTER_ADDR=<node0-ip> NODE_RANK=1 bash examples/megatron/models/deepseek-v4/gfx942/run_full_4k_multinode.sh
#   # node 2:
#   MASTER_ADDR=<node0-ip> NODE_RANK=2 bash examples/megatron/models/deepseek-v4/gfx942/run_full_4k_multinode.sh
#
...
# examples/megatron/models/deepseek-v4/gfx942/README_full_4k_multinode.md.
set -uo pipefail
...
exec bash examples/megatron/models/deepseek-v4/run_deepseek_v4_flash.sh > "${LOG}" 2>&1
