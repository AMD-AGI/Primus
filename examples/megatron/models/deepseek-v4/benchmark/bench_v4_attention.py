...
Run inside the dev container (gfx950 / MI355X):
    ...
    python examples/megatron/models/deepseek-v4/benchmark/bench_v4_attention.py
    python examples/megatron/models/deepseek-v4/benchmark/bench_v4_attention.py --variant pro --cr 4
"""
