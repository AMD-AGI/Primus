...
#     bash examples/megatron/models/deepseek-v4/run_deepseek_v4_flash.sh
#
...
if command -v spur >/dev/null 2>&1; then
    ...
    #   SLURM_ALLOC_JOB_ID=<granted id> bash examples/megatron/models/deepseek-v4/run_deepseek_v4_flash.sh
...
{
    echo "# GENERATED by examples/megatron/models/deepseek-v4/run_deepseek_v4_flash.sh -- do not edit."
