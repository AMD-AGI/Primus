...
from megatron.bridge.recipes.qwen.qwen3 import qwen3_8b_finetune_config
...
DEFAULT_CONFIG_FILENAME: str = "qwen3_8b_finetune.yaml"
DEFAULT_CONFIG_FILE_PATH: Path = Path(
    "/workspace/Primus/third_party/megatron-bridge/examples/recipes/qwen3/conf/qwen3_8b_finetune.yaml"
)
...
def main() -> None:
    ...
    cfg: ConfigContainer = qwen3_8b_finetune_config(   #qwen3_next_80b_a3b_finetune_config(
