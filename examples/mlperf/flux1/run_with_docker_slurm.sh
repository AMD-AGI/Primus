...
forward_vars=(
    ...
    FSDP2_RESHARD_AFTER_FORWARD FSDP2_REDUCE_DTYPE FLUX_FP8_ALL_GATHER FLUX_GPU_PERF_LEVEL FLUX_PERFORMANCE_MODE
    PIN_FLUX_T5_STACK SAVE_STEPS SAVE_STRATEGY CHECKPOINT_KEEP_LATEST RESUME_FROM_CHECKPOINT
