...
srun -N "${NNODES}" \
     ...
     --reservation=mi355-gpu-11_mi355-gpu-12_mi355-gpu-13_mi355-gpu-14_mi355-gpu-17_mi355-gpu-18_mi355-gpu-19_mi355-gpu-20_Reservation \
     --exclusive --mem=0 -N 1  --nodes=4 --time=00:30:00 \
     bash -c "
