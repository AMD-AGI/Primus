...
######################### Training Config #########################
export EXP="examples/megatron/configs/grok2-pretrain.yaml"
export NNODES=8
MBS=2
TP=1
ETP=1
...
# CONFIG="Grok2.debug"
CONFIG="Grok2.FP8-$FP8.nodes$NNODES.GBS$GBS.MBS$MBS.PP$PP.EP$EP.CP$CP.VPP$VPP.rc-$RECOMPUTE_LAYERS"
echo "config: $CONFIG"
