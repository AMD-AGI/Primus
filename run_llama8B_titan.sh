...
export EXP="examples/torchtitan/configs/llama3.1_8B-FP8-pretrain.yaml"
mkdir -p data
...
export PRIMUS_WORKSPACE=output/llama3-8B 
export PRIMUS_USER=john
export PRIMUS_GROUP="date-$(date +%Y%m%d-%H%M%S)"
export PRIMUS_EXP_NAME=llama3.1_8B-FP8-pretrain
