...
export PRIMUS_EXP_NAME=moe_proxy-pretrain-mbs_$MBS-gbs_$GBS-headdim_$HEAD_DIM-turbogg_$TURBO_GROUPED_MLP-turbodeepep_$TURBO_DEEPEEP-legacygg_$LEGACY_GG
