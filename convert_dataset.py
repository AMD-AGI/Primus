...
# Repo root (directory containing this script); works regardless of cwd.
_PRIMUS_ROOT = str(Path(__file__).resolve().parent)
if _PRIMUS_ROOT not in sys.path:
    sys.path.insert(0, _PRIMUS_ROOT)
